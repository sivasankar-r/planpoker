...
public class SnippetSettings
{
     ...
     */
    public static String SERVER_URL = "http://10.105.5.109:8080/tfs";
     ...
     */
    public static String COLLECTION_URL = "http://10.105.5.109:8080/tfs/BoeingBU";
    ...
    public static String USERNAME = "azhagesan.r";
    public static String PASSWORD = "krIshnan!06";
   /* public static String HTTP_PROXY_URL = "arihant-proxy";
    public static String HTTP_PROXY_USERNAME = "hcltech\\azhagesan.r";
    public static String HTTP_PROXY_PASSWORD = "krIshnan!06";*/
     ...
     */
    public static String PROJECT_NAME = "PatternValidation";
